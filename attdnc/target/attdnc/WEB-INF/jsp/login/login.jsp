...
<body>
	...
	<div class="background">
		<div class="header">
			...
			<a class="seperator" onclick="reg_corp()">기업회원가입</a>
			<a onclick="reg_acpt()">승인현황조회</a>
		</div>
	</div>
	...
	function init() {
		...
		var getId = nullToEmpty(document.getElementById("ipt_id").value);
		var getPw = nullToEmpty(document.getElementById("ipt_pw").value);
	...
	// 임직원가입
	function reg_user() {
		location.href = '../register/reg_user.jsp';
	}
	
	// 기업회원가입
	function reg_corp() {
		location.href = '../register/reg_corp.jsp';
	}
	
	// 승인현황조회
	function reg_acpt() {
		location.href = '../register/reg_acpt.jsp';
	}
